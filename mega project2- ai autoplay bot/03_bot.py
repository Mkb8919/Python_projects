...
while True:
    ...
    if is_last_message_from_sender(chat_history):
        ...
        completion = client.chat.completions.create(
         ...
         messages=[
            {"role": "system",
             "content": "You are a person named Naruto who speaks hindi as well as english. You are from"
                        "India and you are a coder.You analyze chat history and roast people in a funny way. "
